...
class ArbitrageBot:
    ...
    def check_arbitrage(self, token_a, token_b, amount_borrow):
        ...
        gas_cost = 500000 * self.web3.eth.gasPrice / 1e18  # Estimated gas cost in ETH
    ...
    def execute_arbitrage(self, token_a, token_b, amount_borrow):
        ...
        tx = contract.functions.initiateArbitrage(
            token_a, amount_borrow, UNISWAP_ROUTER, self.sushiswap.address, token_a, token_b
        ).buildTransaction({
            "from": ACCOUNT,
            "gas": 500000,
